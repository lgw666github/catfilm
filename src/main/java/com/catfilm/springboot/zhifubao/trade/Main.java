package com.catfilm.springboot.zhifubao.trade;
...
import com.catfilm.springboot.zhifubao.trade.model.builder.*;
import com.catfilm.springboot.zhifubao.trade.model.hb.*;
import com.catfilm.springboot.zhifubao.trade.model.result.AlipayF2FPayResult;
import com.catfilm.springboot.zhifubao.trade.model.result.AlipayF2FPrecreateResult;
import com.catfilm.springboot.zhifubao.trade.model.result.AlipayF2FQueryResult;
import com.catfilm.springboot.zhifubao.trade.model.result.AlipayF2FRefundResult;
import com.catfilm.springboot.zhifubao.trade.service.AlipayMonitorService;
import com.catfilm.springboot.zhifubao.trade.service.AlipayTradeService;
import com.catfilm.springboot.zhifubao.trade.service.impl.AlipayMonitorServiceImpl;
import com.catfilm.springboot.zhifubao.trade.service.impl.AlipayTradeServiceImpl;
import com.catfilm.springboot.zhifubao.trade.service.impl.AlipayTradeWithHBServiceImpl;
import com.catfilm.springboot.zhifubao.trade.utils.Utils;
    ...
    public void test_trade_precreate() {
        ...
        switch (result.getTradeStatus()) {
            case SUCCESS:
                ...
                // 需要修改为运行机器上的路径
                String filePath = String.format("C:/Users/86175/Desktop/erweima/qr-%s.png",
